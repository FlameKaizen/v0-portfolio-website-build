...
export function GalaxyCursor() {
  ...
  return (
    <>
      ...
      >
        <div className="w-full h-full rounded-full bg-gradient-to-r from-purple-400 to-blue-400 opacity-80" />
      </motion.div>
      ...
      >
        <div className="w-full h-full rounded-full bg-purple-300 opacity-40" />
      </motion.div>
    </>
  )
}
